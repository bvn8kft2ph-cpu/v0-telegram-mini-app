...
export const he = {
  ...
  // Booking
  bookService: "הזמנת תור",
  selectDate: "בחרי תאריך",
  selectTime: "בחרי שעה",
  confirmBooking: "אישור תור",
  bookingConfirmed: "התור אושר!",
  bookingConfirmedDesc: "נשלח לך אישור בווטסאפ",
  yourName: "שם מלא",
  yourPhone: "טלפון",
  noSlotsAvailable: "אין תורים פנויים",
  closedDay: "סגור",
  ...
  whatsappConfirm: "אישור בווטסאפ",
  bookingPending: "ממתין לאישור בווטסאפ",
